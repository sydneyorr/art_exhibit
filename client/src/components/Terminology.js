 ...
 const terms = [
  ...
  return (
    ...
    <div style={{color: 'white', alignItems: 'flex-start', marginRight: '60px'}}>
      ...
      <h3 style={{color: 'lightblue'}}>Concavity</h3>
      ...
      <h3 style={{color: 'lightblue'}}>Tangent lines</h3>
      ...
      <h3 style={{color: 'lightblue'}}>Secant lines</h3>
      ...
      <h3 style={{color: 'lightblue'}}>Extreme Values</h3>
