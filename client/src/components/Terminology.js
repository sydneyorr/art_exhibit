 ...
 const terms = [
  ...
  return (
    ...
    <div style={{color: 'white', alignItems: 'flex-start', marginRight: '60px'}}>
      ...
      <h3 style={{color: 'pink'}}>Concavity</h3>
      ...
      <h3 style={{color: 'pink'}}>Tangent lines</h3>
      ...
      <h3 style={{color: 'pink'}}>Secant lines</h3>
      ...
      <h3 style={{color: 'pink'}}>Extreme Values</h3>
