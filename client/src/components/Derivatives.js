...
const Derivatives = () => {
  return (
    <div style={{color: 'white'}}>
      ...
      <h2 style={{color: 'white'}}>What is a derivative?</h2>
      ...
      <h2 style={{color: 'white'}}>Second Derivative</h2>
      <p>Second derivatives show the instantaneous rate of change of the derivative function. They tell us how a function is increasing or decreasing  (speeding up, slowing down, or increasing at the same rate).</p>
      <TermBox>
        {/* <h3>Example</h3> */}
